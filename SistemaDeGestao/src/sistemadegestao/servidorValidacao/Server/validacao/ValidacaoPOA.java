...
public abstract class ValidacaoPOA extends org.omg.PortableServer.Servant
 implements sistemadegestao.servidorValidacao.Server.validacao.ValidacaoOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    switch (__method.intValue ())
    {
       ...
       case 6:  // validacao/Validacao/validarTelefone
       {
        ...
        try {
         ...
         out = $rh.createReply();
                sistemadegestao.servidorValidacao.Server.validacao.ArrayHelper.write (out, $result);
         break;
       }
