...
--
-- Host: 127.0.0.1    Database: clinicaoop
-- ------------------------------------------------------
...
INSERT INTO `consulta` VALUES (600001,'2022-01-15','11:15:15',''),(600002,'2021-01-15','10:15:15',''),(600003,'2022-01-05','05:15:15',''),(600004,'2022-01-05','05:55:15',''),(600005,'2022-01-05','15:55:15',''),(600006,'2022-01-13','15:45:15','');
...
--
-- Table structure for table `consulta_medico`
--
...
--
-- Dumping data for table `consulta_medico`
--

LOCK TABLES `consulta_medico` WRITE;
/*!40000 ALTER TABLE `consulta_medico` DISABLE KEYS */;
INSERT INTO `consulta_medico` VALUES (202002,600001),(202003,600002);
/*!40000 ALTER TABLE `consulta_medico` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `funcionario` VALUES (27,'Gloria Uamusse','Femenino','11111111','Fomento','Mocambicana','Pediatria'),(68,'Ana Maria','Femenino','1236554789','Matola C','Mocambicana','Pediatria'),(73,'dscdscs','Masculino','845223896','sdcsdcdsc','dssdvsffv','sdcdscdsc'),(93,'xcvbn','Femenino','665135165','Magude','Moz','Producao'),(98,'sdcdsc','Masculino','845223896','dscdsc','sdcdscd','dscdscdscd'),(112,'Ana Maria da Graca','Femenino','847689409','Fomento','Cubana','xxxxxxx'),(141,'vhvhgg','Femenino','468966jbj','mgcyhg','nbvhvjhbjh','mnn,m,m'),(157,'Marcos Antonio','Masculino','33333333','Fomento','Gana','Estomatologia'),(183,'Camila Lucas','Femenino','87251878','Matola','Russa','cardiologia'),(189,'Mateus','Masculino','4444444','Fomento','Moz','CArio'),(207,'Lucas Amancio','Masculino','8457654','Matola','Russa','Cardiologia'),(212,'','Femenino','','','',''),(217,'dewdewd','Masculino','845223896','ssadsad','sadde','sadsads'),(228,'xcdacdc','Masculino','845223896','adafdf','dcdscdsc','adfadfadf'),(278,'qwdsd','Masculino','845223896','saddaa','adada','afsfffefe'),(309,' cx cxc cx','Masculino','cx cx ','acdacasdc','xc cx ','dcscscs'),(414,'frfer','Masculino','845223896','dwedwed','dfrferf','dwedewd'),(489,'mdrttgu','Masculino','59656hv','mhhfyu8','mvghvhvch','uhggggfh'),(572,'Vania Amancio','Femenino','84759415','Ndlavela','Gana','Ortopedia'),(626,'Miguel','Masculino','2222222','Maputo','Russa','Ortopedia'),(658,'dewdewd','Femenino','845223896','ewdewdew','wedewdew','ewdewdew'),(882,'saxasxas','Masculino','845223896','ASAs','xasasxsa','DFDFDFD'),(926,'Graca Maria','Femenino','847689409','MAtola','Russa','Cardiologia'),(202001,'Amarilda','F','1000000000','','',''),(202002,'Celestino','M','100000001','','',''),(202003,'Kelvin','M','100000002','','',''),(202004,'Ludi','F','100000003','','',''),(202005,'Agostinho','M','100000004','','',''),(202006,'Faira','F','100000005','','','');
...
INSERT INTO `medico` VALUES (73,'sdcsdcdsc'),(93,'Enfermeiro'),(96,'hjgfdsdfgh'),(98,'sdcdscds'),(112,'Cortador'),(141,'jn jhjh'),(217,'asdsadsa'),(228,'afafadf'),(278,'Historia'),(309,'cdsacdsc'),(414,'Morning'),(489,'gvhgvv'),(658,'ewdewdew'),(882,'SDSDC'),(202002,'Cardiologista'),(202003,'Oftalmologita');
...
INSERT INTO `secretario` VALUES (202001,'Amarilda','amarildachihepe@gmail.com','Secretario',1),(1502,'Baloi','baloi@gmail.com','Professor',2);
...
-- Dump completed on 2022-01-19 11:36:29
